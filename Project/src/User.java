...
public class User {
     ...
     *
     * @return En ny User-intand med brugerens oplysninger.
     */
    public static User registerAccount() {
        ...
        int age;
        // Laver en løkke der sikrer at alderen er mellem 12 og 120
        while (true) {
            ...
            if (age >= 12 && age <= 120) {
                break; // Stopper loopet her, hvis alderen er gyldig
            } else {
    ...
    /**
     * Konverterer brugerens oplysninger til en CSV format streng, som kan bruges til filgaming.
     * @return CSV streng
     */
    public String toCSV() {
    ...
    private static int generateID() {
        return (int) (Math.random() * 10000); // Genererer en tilfældig ID mellem 0 og 9999
    }
}
